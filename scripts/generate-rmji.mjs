...
const catalog = {
  ...
  characters: [
    ...
    item('zi-ling', '紫灵', 'Zi Ling', 'Zi Ling', '乱星海至后续', 'Chaotic Star Sea and later', '与乱星海、妙音门和韩立长期交集相关的代表性人物。', 'A representative figure tied to the Chaotic Star Sea, Miao Yin Sect, and long-running intersections with Han Li.', '她适合连接乱星海商业势力、身份伪装和情感支线。', 'She links maritime commercial factions, hidden identities, and emotional side threads.', ['miao-yin-sect', 'chaotic-star-sea', 'han-li'], 'high'),
    ...
    item('six-extremes', '六极圣祖', 'Six Extremes Sacred Ancestor', 'Liuji Shengzu', '灵界至魔界线', 'Spirit to Devil Realm thread', '魔族高阶人物之一，先作为魔界人物索引收录。', 'A high-level devil-race figure included first as a Devil Realm character index.', '后续可补分身、势力和与其他圣祖关系，当前保持轻剧透概览。', 'Later passes can add avatar threads, faction ties, and relations with other sacred ancestors.', ['devil-race', 'demon-realm'], 'verify'),
    item('crab-daoist', '蟹道人', 'Crab Daoist', 'Xie Daoren', '灵界至仙界篇', 'Spirit Realm to Immortal World Arc', '与傀儡、守护、跨界传承和仙界篇线索相关的重要角色。', 'An important figure tied to puppets, guardianship, cross-realm inheritance, and sequel threads.', '蟹道人适合连接技术型法宝、傀儡体系和仙界篇早期保护关系。', 'Crab Daoist links technical treasures, puppet systems, and early sequel protective relationships.', ['puppet', 'immortal-realm-opening', 'han-li'], 'high'),
    item('golden-child', '金童', 'Golden Child', 'Jintong', '仙界篇', 'Immortal World Arc', '仙界篇中与韩立同行、成长和高阶灵虫线索相关的重要伙伴。', 'An important sequel companion tied to Han Li travels, growth, and high-level spirit-insect threads.', '她可与噬金虫、噬金虫王和仙界资源成长体系互链。', 'She links naturally with gold-devouring beetles, beetle king evolution, and immortal-world resource growth.', ['gold-devouring-beetles', 'gold-devouring-beetle-king', 'han-li'], 'high'),
    item('weeping-soul-character', '啼魂', 'Weeping Soul', 'Tihun', '人界至仙界篇', 'Mortal Realm to Immortal World Arc', '由灵兽伙伴发展出的长期同行角色，尤其适合连接魂魄、鬼物和轮回线索。', 'A long-running companion evolved from a spirit-beast role, especially tied to souls, ghosts, and reincarnation threads.', '人物页补足了法宝灵兽页之外的情感和陪伴维度。', 'This character page adds emotional and companion dimensions beyond the artifact-companion entry.', ['weeping-soul-beast', 'reincarnation-law', 'gray-realm'], 'high'),
    item('shi-chuankong', '石穿空', 'Shi Chuankong', 'Shi Chuankong', '仙界篇', 'Immortal World Arc', '仙界篇重要同行或盟友型人物之一，连接仙界身份、流亡和势力线索。', 'An important sequel companion or ally figure linked to immortal-world identity, exile, and faction threads.', '先建立人物入口，后续可补家族背景、同行阶段和关键事件。', 'This creates a character entry; later passes can add family background, travel stages, and key events.', ['immortal-realm-opening', 'north-cold-immortal-domain', 'han-li'], 'medium'),
    item('jiao-san', '蛟三', 'Jiao San', 'Jiao San', '仙界篇', 'Immortal World Arc', '仙界篇中与轮回殿、身份伪装和任务网络相关的人物线索。', 'A sequel figure tied to Reincarnation Palace, hidden identity, and mission networks.', '适合与轮回殿、轮回法则和仙界政治暗线互链。', 'Best linked with Reincarnation Palace, reincarnation law, and hidden immortal-world politics.', ['reincarnation-palace', 'reincarnation-law'], 'medium'),
    item('fox-three', '狐三', 'Fox Three', 'Hu San', '仙界篇', 'Immortal World Arc', '仙界篇中较有辨识度的同行人物之一，适合归入任务、身份和仙界关系网。', 'A recognizable sequel companion figure suited to mission, identity, and immortal-world relationship networks.', '先作为索引收录，后续可补具体行动线和与其他角色的关系。', 'Included as an index first; later passes can add action routes and relations with other figures.', ['immortal-realm-opening', 'reincarnation-palace'], 'medium'),
    ...
    item('gan-jiuzhen', '甘九真', 'Gan Jiuzhen', 'Gan Jiuzhen', '仙界篇历史线', 'Immortal World historical thread', '仙界篇中与真言门、时间线索和历史因果相关的人物。', 'A sequel figure tied to True Word Sect, time threads, and historical karma.', '她适合连接真言门遗迹、真言化轮经和时间法则。', 'She fits links with True Word Sect ruins, the Mantra Wheel Scripture, and time law.', ['true-word-sect', 'mantra-wheel-scripture', 'time-law'], 'medium'),
    item('liu-le-er', '柳乐儿', 'Liu Leer', 'Liu Leer', '仙界篇早期', 'Early Immortal World Arc', '仙界篇开局阶段的重要人物之一，承接韩立初入仙界后的情感和因果线。', 'An important early sequel figure carrying emotional and karmic threads after Han Li enters the Immortal World.', '先建立人物入口，后续补具体身份、相遇阶段和后续成长。', 'This creates the character entry; later passes can add identity, meeting stage, and later growth.', ['immortal-realm-opening', 'han-li'], 'medium'),
    ...
    item('reincarnation-palace-master', '轮回殿主', 'Reincarnation Palace Master', 'Lunhui Dianzhu', '仙界篇高阶', 'High-level sequel', '轮回殿相关最高层人物线索，牵动轮回法则和仙界政治冲突。', 'A top-level Reincarnation Palace figure tied to reincarnation law and immortal-world political conflict.', '先作为高阶人物索引收录，避免过度剧透；后续可按法则线补充。', 'Included first as a high-level character index without over-spoiling; later passes can add law-path details.', ['reincarnation-palace', 'reincarnation-law', 'heavenly-court'], 'verify'),
...
const supplementalCatalog = {
  ...
  characters: [
    ...
    item('qi-mozi', '奇摩子', 'Qi Mozi', 'Qi Mozi', '仙界篇', 'Immortal World Arc', '仙界篇重要对手线索之一，常与追杀、法则斗争和高阶压迫相关。', 'An important sequel opponent thread tied to pursuit, law conflict, and high-level pressure.', '他的页面用于承接仙界篇“被追索”和“高阶敌手”主题。', 'His page supports sequel themes of pursuit and high-level enemies.', ['heavenly-court', 'time-law', 'han-li'], 'medium'),
    ...
    item('gu-huajin', '古或今', 'Gu Huojin', 'Gu Huojin', '仙界篇高阶', 'High-level sequel', '仙界篇顶层权力与时间法则相关的重要人物线索。', 'A high-level sequel figure tied to top immortal power and time law.', '此页会涉及较强剧透，当前保持百科式轻概览。', 'This can be highly spoilery, so the current page stays at a reference-summary level.', ['time-dao-ancestor', 'time-law', 'heavenly-court'], 'verify')
  ],
  timeline: [
...
function entriesForSection(sectionSlug) {
  ...
  if (sectionSlug !== 'timeline') return entries
...
function rmjiHome(locale) {
  ...
  const featuredSlugs = ['han-li', 'nangong-wan', 'doctor-mo', 'zhangtian-bottle', 'qingyuan-sword-art', 'green-bamboo-cloudswarm-swords', 'heavenly-court', 'time-law']
