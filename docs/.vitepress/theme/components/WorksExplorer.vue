...
const works: Work[] = [
  ...
  { slug: 'rmji-immortal-world', zh: '凡人修仙之仙界篇', en: 'RMJI: Immortal World Arc', author: '忘语', authorEn: 'Wang Yu', genre: '仙界篇', genreEn: 'Immortal World Arc', status: 'completed', descZh: '韩立飞升后的续篇，重心转向仙界秩序、法则体系与高阶势力。', descEn: 'The sequel after Han Li ascends, shifting toward immortal-world order, laws, and high-level factions.' },
