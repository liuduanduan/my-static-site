---
title: "Ghosts and Yin Souls"
zh_name: "鬼物阴魂"
en_name: "Ghosts and Yin Souls"
pinyin: "Guiwu Yinhun"
category: "Races & Peoples"
arc: "Ghost-path thread"
...
description: "A hub for yin souls, ghosts, remnant spirits, and underworld-like beings."
---

# Ghosts and Yin Souls / 鬼物阴魂

<div class="term-meta">
  <div><strong>Chinese</strong><span>鬼物阴魂</span></div>
  <div><strong>English</strong><span>Ghosts and Yin Souls</span></div>
  <div><strong>Pinyin</strong><span>Guiwu Yinhun</span></div>
  <div><strong>Topic</strong><span>Races & Peoples</span></div>
</div>

## Summary

A hub for yin souls, ghosts, remnant spirits, and underworld-like beings.

## Role in RMJI

It forms the soul thread with Weeping Soul, Yuan Yao, and soul-nurturing wood.
...
| Arc label | Ghost-path thread |
| Chapter segment | Ghost-path thread related chapter segment |
...
| Chapter segment | Ghost-path thread related chapter segment |
| First check point | First appearance of Ghosts and Yin Souls remains to be refined by chapter |
| Main place | Mortal Realm |
| People | Han Li and related figures |
| Event | A hub for yin souls, ghosts, remnant spirits, and underworld-like beings. |
...
| --- | --- |
| Chinese name | 鬼物阴魂 |
| English name | Ghosts and Yin Souls |
| Pinyin | Guiwu Yinhun |
| Topic | [Races & Peoples](/en/rmji/races/) |
| Timeline node | Mortal Realm 03 | Yue Seven Sects and Foundation Establishment |
| Main arc | Ghost-path thread |
| Chapter check | arc checked |
| Legacy confidence | high |

## Related Entries

- [Ghost-Path Arts / 鬼道功法](/en/rmji/techniques/ghost-path-arts)
- [Weeping Soul Beast / 啼魂兽](/en/rmji/artifacts/weeping-soul-beast)
- [Yuan Yao / 元瑶](/en/rmji/characters/yuan-yao)
