...
zh_name: "古魔"
en_name: "Ancient Devils"
pinyin: "Gumo"
category: "Races & Peoples"
arc: "Mortal to Devil Realm thread"
check_status: "high"
description: "A more ancient and threatening devilish presence than ordinary devil-race figures."
---

# Ancient Devils / 古魔

<div class="term-meta">
  <div><strong>Chinese</strong><span>古魔</span></div>
  <div><strong>English</strong><span>Ancient Devils</span></div>
  <div><strong>Pinyin</strong><span>Gumo</span></div>
  <div><strong>Topic</strong><span>Races & Peoples</span></div>
</div>

## Summary

A more ancient and threatening devilish presence than ordinary devil-race figures.
...
| --- | --- |
| Chinese name | 古魔 |
| English name | Ancient Devils |
| Pinyin | Gumo |
| Topic | [Races & Peoples](/en/rmji/races/) |
| Main arc | Mortal to Devil Realm thread |
| Check status | high |
