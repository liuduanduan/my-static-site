---
title: "Heavenly Phoenix Lineage"
zh_name: "天凤血脉"
en_name: "Heavenly Phoenix Lineage"
pinyin: "Tianfeng Xuemei"
category: "Races & Peoples"
arc: "True-spirit thread"
...
description: "A true-spirit lineage thread around heavenly phoenix ancestry and high-level demon-race inheritance."
---

# Heavenly Phoenix Lineage / 天凤血脉

<div class="term-meta">
  <div><strong>Chinese</strong><span>天凤血脉</span></div>
  <div><strong>English</strong><span>Heavenly Phoenix Lineage</span></div>
  <div><strong>Pinyin</strong><span>Tianfeng Xuemei</span></div>
  <div><strong>Topic</strong><span>Races & Peoples</span></div>
</div>

## Summary

A true-spirit lineage thread around heavenly phoenix ancestry and high-level demon-race inheritance.

## Role in RMJI

It cross-links with Ice Phoenix, Silvermoon, and true-spirit blood.
...
| Arc label | True-spirit thread |
| Chapter segment | True-spirit thread related chapter segment |
...
| Chapter segment | True-spirit thread related chapter segment |
| First check point | First appearance of Heavenly Phoenix Lineage remains to be refined by chapter |
| Main place | Mortal Realm |
| People | Han Li and related figures |
| Event | A true-spirit lineage thread around heavenly phoenix ancestry and high-level demon-race inheritance. |
