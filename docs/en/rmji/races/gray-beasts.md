...
description: "Alien creatures in the Gray Realm ecology, useful for showing environmental difference and material sources."
---

# Gray Beasts / 灰兽

<div class="term-meta">
  <div><strong>Chinese</strong><span>灰兽</span></div>
  <div><strong>English</strong><span>Gray Beasts</span></div>
  <div><strong>Pinyin</strong><span>Huishou</span></div>
  <div><strong>Topic</strong><span>Races & Peoples</span></div>
</div>

## Summary

Alien creatures in the Gray Realm ecology, useful for showing environmental difference and material sources.

## Role in RMJI

They give the Gray Realm its own ecology, not only gray-immortal society.
...
- [Gray Realm / 灰界](/en/rmji/regions/gray-realm)
- [Gray-Realm Materials / 灰界材料](/en/rmji/elixirs/gray-realm-materials)
- [Gray-Realm Crystals / 灰界晶石](/en/rmji/elixirs/gray-crystals)
