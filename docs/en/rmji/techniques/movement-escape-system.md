---
title: "Escape-Art System"
zh_name: "遁法体系"
en_name: "Escape-Art System"
pinyin: "Dunfa Tixi"
...
description: "A hub for speed, concealment, teleportation, wind-thunder movement, and survival retreat."
---

# Escape-Art System / 遁法体系

<div class="term-meta">
  <div><strong>Chinese</strong><span>遁法体系</span></div>
  <div><strong>English</strong><span>Escape-Art System</span></div>
  <div><strong>Pinyin</strong><span>Dunfa Tixi</span></div>
  <div><strong>Topic</strong><span>Techniques & Abilities</span></div>
</div>

## Summary

A hub for speed, concealment, teleportation, wind-thunder movement, and survival retreat.

## Role in RMJI

It is a core technical group for mortal-flow survival-first logic.
...
| Effect | It is a core technical group for mortal-flow survival-first logic. |
...
| Chapter segment | Whole-series recurring system related chapter segment |
| First check point | First appearance of Escape-Art System remains to be refined by chapter |
| Main place | Mortal Realm |
| People | Han Li and related figures |
| Event | A hub for speed, concealment, teleportation, wind-thunder movement, and survival retreat. |
| Materials / arts | Escape-Art System |
...
| --- | --- |
| Chinese name | 遁法体系 |
| English name | Escape-Art System |
| Pinyin | Dunfa Tixi |
...
- [Concealment and Escape Arts / 敛息遁术](/en/rmji/techniques/stealth-escape-arts)
- [Lightning Escape / 雷遁](/en/rmji/techniques/lightning-escape)
