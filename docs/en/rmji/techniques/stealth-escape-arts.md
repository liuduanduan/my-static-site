---
title: "Concealment and Escape Arts"
zh_name: "敛息遁术"
en_name: "Concealment and Escape Arts"
pinyin: "Lianxi Dunshu"
category: "Techniques & Abilities"
arc: "Whole-series recurring system"
timeline_node: "Mortal Realm 02 | Foundational systems that continue later"
check_status: "arc checked"
legacy_check_status: "high"
description: "Life-preserving arts around hiding aura, shifting identity, and escaping quickly."
---

# Concealment and Escape Arts / 敛息遁术

<div class="term-meta">
  <div><strong>Chinese</strong><span>敛息遁术</span></div>
  <div><strong>English</strong><span>Concealment and Escape Arts</span></div>
  <div><strong>Pinyin</strong><span>Lianxi Dunshu</span></div>
  <div><strong>Topic</strong><span>Techniques & Abilities</span></div>
</div>

## Summary

Life-preserving arts around hiding aura, shifting identity, and escaping quickly.

## Role in RMJI

In RMJI, survival often matters more than momentary victory, and these methods embody Han Li risk-first logic.
...
| Arc label | Whole-series recurring system |
| Chapter segment | Whole-series recurring system related chapter segment |
...
| Source / acquisition | Whole-series recurring system related chapter segment |
...
| Effect | In RMJI, survival often matters more than momentary victory, and these methods embody Han Li risk-first logic. |
...
| Chapter segment | Whole-series recurring system related chapter segment |
| First check point | First appearance of Concealment and Escape Arts remains to be refined by chapter |
| Main place | Mortal Realm |
| People | Han Li and related figures |
| Event | Life-preserving arts around hiding aura, shifting identity, and escaping quickly. |
| Materials / arts | Concealment and Escape Arts |
...
| --- | --- |
| Chinese name | 敛息遁术 |
| English name | Concealment and Escape Arts |
| Pinyin | Lianxi Dunshu |
| Topic | [Techniques & Abilities](/en/rmji/techniques/) |
| Timeline node | Mortal Realm 02 | Foundational systems that continue later |
| Main arc | Whole-series recurring system |
| Chapter check | arc checked |
| Legacy confidence | high |

## Related Entries

- [Wind-Thunder Wings / 风雷翅](/en/rmji/artifacts/wind-thunder-wings)
- [Black Wind Sea / 黑风海域](/en/rmji/regions/black-wind-sea)
- [Han Li / 韩立](/en/rmji/characters/han-li)
