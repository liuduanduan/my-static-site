---
title: "Protective Sword Shield"
zh_name: "护体剑盾"
en_name: "Protective Sword Shield"
pinyin: "Huti Jiandun"
...
description: "A defensive Azure Essence Sword Art mode with counterattack potential."
---

# Protective Sword Shield / 护体剑盾

<div class="term-meta">
  <div><strong>Chinese</strong><span>护体剑盾</span></div>
  <div><strong>English</strong><span>Protective Sword Shield</span></div>
  <div><strong>Pinyin</strong><span>Huti Jiandun</span></div>
  <div><strong>Topic</strong><span>Techniques & Abilities</span></div>
</div>

## Summary

A defensive Azure Essence Sword Art mode with counterattack potential.

## Role in RMJI

It shows Han Li sword path serves survival and positioning as well as offense.
...
| Effect | It shows Han Li sword path serves survival and positioning as well as offense. |
...
| Chapter segment | Middle Azure Essence Sword Art related chapter segment |
| First check point | First appearance of Protective Sword Shield remains to be refined by chapter |
| Main place | Mortal Realm |
| People | Han Li and related figures |
| Event | A defensive Azure Essence Sword Art mode with counterattack potential. |
| Materials / arts | Protective Sword Shield |
...
| --- | --- |
| Chinese name | 护体剑盾 |
| English name | Protective Sword Shield |
| Pinyin | Huti Jiandun |
...
- [Shield Artifacts / 护盾法宝](/en/rmji/artifacts/shield-artifacts)
