---
title: "Sword-Light Splitting"
zh_name: "剑影分光术"
en_name: "Sword-Light Splitting"
pinyin: "Jianying Fenguang Shu"
category: "Techniques & Abilities"
arc: "Middle Azure Essence Sword Art"
...
description: "A key Azure Essence Sword Art method that turns sword light into multiple sword shadows."
---

# Sword-Light Splitting / 剑影分光术

<div class="term-meta">
  <div><strong>Chinese</strong><span>剑影分光术</span></div>
  <div><strong>English</strong><span>Sword-Light Splitting</span></div>
  <div><strong>Pinyin</strong><span>Jianying Fenguang Shu</span></div>
  <div><strong>Topic</strong><span>Techniques & Abilities</span></div>
</div>

## Summary

A key Azure Essence Sword Art method that turns sword light into multiple sword shadows.

## Role in RMJI

It moves flying-sword control from one-line offense toward confusion, restraint, and multi-point pressure.
...
| Arc label | Middle Azure Essence Sword Art |
| Chapter segment | Middle Azure Essence Sword Art related chapter segment |
...
| Source / acquisition | Middle Azure Essence Sword Art related chapter segment |
...
| Effect | It moves flying-sword control from one-line offense toward confusion, restraint, and multi-point pressure. |
...
| Chapter segment | Middle Azure Essence Sword Art related chapter segment |
| First check point | First appearance of Sword-Light Splitting remains to be refined by chapter |
| Main place | Mortal Realm |
| People | Han Li and related figures |
| Event | A key Azure Essence Sword Art method that turns sword light into multiple sword shadows. |
| Materials / arts | Sword-Light Splitting |
...
| --- | --- |
| Chinese name | 剑影分光术 |
| English name | Sword-Light Splitting |
| Pinyin | Jianying Fenguang Shu |
| Topic | [Techniques & Abilities](/en/rmji/techniques/) |
| Timeline node | Mortal Realm 03 | Yue Seven Sects and Foundation Establishment |
| Main arc | Middle Azure Essence Sword Art |
...
- [Flying-Sword Control / 御剑术](/en/rmji/techniques/flying-sword-control)
- [Great Geng Sword Formation / 大庚剑阵](/en/rmji/techniques/dageng-sword-array)
