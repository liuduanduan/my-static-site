---
title: "Great Ascension Stage"
zh_name: "大乘期"
en_name: "Great Ascension Stage"
pinyin: "Dacheng Qi"
category: "Laws & Dao"
arc: "Top Spirit Realm stage"
timeline_node: "Spirit Realm 01 | Ascension landing and Heavenly Abyss City"
check_status: "arc checked"
legacy_check_status: "high"
description: "A near-top Spirit Realm stage whose experts can affect racial security and cross-realm events."
---

# Great Ascension Stage / 大乘期

<div class="term-meta">
  <div><strong>Chinese</strong><span>大乘期</span></div>
  <div><strong>English</strong><span>Great Ascension Stage</span></div>
  <div><strong>Pinyin</strong><span>Dacheng Qi</span></div>
  <div><strong>Topic</strong><span>Laws & Dao</span></div>
</div>

## Summary

A near-top Spirit Realm stage whose experts can affect racial security and cross-realm events.

## Role in RMJI

It is the power benchmark for Spirit Realm strategic conflicts.
...
| Arc label | Top Spirit Realm stage |
...
| --- | --- |
| Chinese name | 大乘期 |
| English name | Great Ascension Stage |
| Pinyin | Dacheng Qi |
| Topic | [Laws & Dao](/en/rmji/laws/) |
| Timeline node | Spirit Realm 01 | Ascension landing and Heavenly Abyss City |
| Main arc | Top Spirit Realm stage |
| Chapter check | arc checked |
| Legacy confidence | high |

## Related Entries

- [Mo Jianli / 莫简离](/en/rmji/characters/mo-jianli)
- [Ao Xiao Ancestor / 敖啸老祖](/en/rmji/characters/ao-xiao-ancestor)
- [Mother of Locusts / 螟虫之母](/en/rmji/races/mother-of-locusts)
