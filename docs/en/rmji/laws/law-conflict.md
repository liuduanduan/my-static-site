...
description: "The collision or suppression among different law attributes, domains, and Dao-authorities."
---

# Law Conflict / 法则冲突

<div class="term-meta">
  <div><strong>Chinese</strong><span>法则冲突</span></div>
  <div><strong>English</strong><span>Law Conflict</span></div>
  <div><strong>Pinyin</strong><span>Faze Chongtu</span></div>
  <div><strong>Topic</strong><span>Laws & Dao</span></div>
</div>

## Summary

The collision or suppression among different law attributes, domains, and Dao-authorities.

## Role in RMJI

It gives high-level combat rule-based contest.
...
| Chapter segment | Immortal World Arc related chapter segment |
| First check point | First appearance of Law Conflict remains to be refined by chapter |
| Main place | Immortal World Arc |
| People | Han Li and related figures |
| Event | The collision or suppression among different law attributes, domains, and Dao-authorities. |
| Materials / arts | Law Conflict |
