...
description: "The suppression of enemy law, movement, and perception after a high-level cultivator unfolds a domain."
---

# Domain Suppression / 灵域压制

<div class="term-meta">
  <div><strong>Chinese</strong><span>灵域压制</span></div>
  <div><strong>English</strong><span>Domain Suppression</span></div>
  <div><strong>Pinyin</strong><span>Lingyu Yazhi</span></div>
  <div><strong>Topic</strong><span>Laws & Dao</span></div>
</div>

## Summary

The suppression of enemy law, movement, and perception after a high-level cultivator unfolds a domain.

## Role in RMJI

It is one of the most visible mechanics of high-level sequel combat.
...
| Chapter segment | Immortal World Arc related chapter segment |
| First check point | First appearance of Domain Suppression remains to be refined by chapter |
| Main place | Immortal World Arc |
| People | Han Li and related figures |
| Event | The suppression of enemy law, movement, and perception after a high-level cultivator unfolds a domain. |
| Materials / arts | Domain Suppression |
...
| --- | --- |
| Chinese name | 灵域压制 |
| English name | Domain Suppression |
| Pinyin | Lingyu Yazhi |
...
- [Spiritual Domain / 灵域](/en/rmji/laws/law-domain)
- [Spiritual Domain Use / 灵域运用](/en/rmji/techniques/law-domain-technique)
- [Law Conflict / 法则冲突](/en/rmji/laws/law-conflict)
