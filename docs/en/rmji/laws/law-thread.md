...
<div class="term-meta">
  <div><strong>Chinese</strong><span>法则之丝</span></div>
  <div><strong>English</strong><span>Law Threads</span></div>
  <div><strong>Pinyin</strong><span>Faze Zhisi</span></div>
  <div><strong>Topic</strong><span>Laws & Dao</span></div>
</div>

## Summary

A detailed concept for expressing law comprehension, condensation, and control.

## Role in RMJI

Included as a sequel terminology seed; later passes should add realm mechanics and combat usage.
