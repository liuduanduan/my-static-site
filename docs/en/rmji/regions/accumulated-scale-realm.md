---
title: "Accumulated Scale Realm"
zh_name: "积鳞空境"
en_name: "Accumulated Scale Realm"
pinyin: "Jilin Kongjing"
category: "Realms & Regions"
arc: "Immortal World special space"
timeline_node: "Immortal World 03 | Gray Realm and Accumulated Scale Realm"
check_status: "arc checked"
legacy_check_status: "medium"
description: "A sequel special-space thread with strong trial, survival, and alien-rule qualities."
---

# Accumulated Scale Realm / 积鳞空境

<div class="term-meta">
  <div><strong>Chinese</strong><span>积鳞空境</span></div>
  <div><strong>English</strong><span>Accumulated Scale Realm</span></div>
  <div><strong>Pinyin</strong><span>Jilin Kongjing</span></div>
  <div><strong>Topic</strong><span>Realms & Regions</span></div>
</div>

## Summary

A sequel special-space thread with strong trial, survival, and alien-rule qualities.

## Role in RMJI

It pairs well with Gray Realm, survival methods, and body-pressure themes.
...
| Arc label | Immortal World special space |
| Chapter segment | Sequel Gray Realm and special-space stage |
...
| Chapter segment | Sequel Gray Realm and special-space stage |
| First check point | Completes Gray Realm society, wilderness danger, alien resources, and survival-rule differences. |
| Main place | Gray Realm cities, wastes, resource fields, Accumulated Scale Realm-related spaces |
| People | Han Li, Shi Chuankong, local Gray Realm powers and elites |
| Event | Completes Gray Realm society, wilderness danger, alien resources, and survival-rule differences. |
| Materials / arts | Gray crystals, Gray Realm materials, alien-beast resources, Gray Realm law/miasma |
| Han Li age estimate | about age 13346-13390 |
...
| --- | --- |
| Chinese name | 积鳞空境 |
| English name | Accumulated Scale Realm |
| Pinyin | Jilin Kongjing |
| Topic | [Realms & Regions](/en/rmji/regions/) |
| Timeline node | Immortal World 03 | Gray Realm and Accumulated Scale Realm |
| Main arc | Immortal World special space |
| Chapter check | arc checked |
| Legacy confidence | medium |

## Related Entries

- [Gray-Realm Survival Arts / 灰界生存术](/en/rmji/techniques/gray-realm-survival-arts)
- [Body-Refining System / 炼体体系](/en/rmji/techniques/body-refining-system)
