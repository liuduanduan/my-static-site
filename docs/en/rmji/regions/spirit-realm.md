...
description: "A higher world after ascension, featuring many races, upgraded resources, and border conflicts."
---

# Spirit Realm / 灵界

<div class="term-meta">
  <div><strong>Chinese</strong><span>灵界</span></div>
  <div><strong>English</strong><span>Spirit Realm</span></div>
  <div><strong>Pinyin</strong><span>Lingjie</span></div>
  <div><strong>Topic</strong><span>Realms & Regions</span></div>
</div>

## Summary

A higher world after ascension, featuring many races, upgraded resources, and border conflicts.
...
| --- | --- |
| Chinese name | 灵界 |
| English name | Spirit Realm |
| Pinyin | Lingjie |
| Topic | [Realms & Regions](/en/rmji/regions/) |
| Timeline node | Spirit Realm 01 | Ascension landing and Heavenly Abyss City |
| Main arc | After ascension |
| Chapter check | arc checked |
| Legacy confidence | high |

## Related Entries

- [Ascension to the Spirit Realm / 飞升灵界](/en/rmji/timeline/spirit-realm-ascension)
- [Heavenly Abyss City / 天渊城](/en/rmji/sects/heavenly-abyss-city)
- [Spirit Race / 灵族](/en/rmji/races/spirit-race)
