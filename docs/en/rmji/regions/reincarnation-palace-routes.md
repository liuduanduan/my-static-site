---
title: "Reincarnation Palace Routes"
zh_name: "轮回殿行动路线"
...
description: "A route hub for Reincarnation Palace missions, strongholds, teleportation, and identity shifts."
---

# Reincarnation Palace Routes / 轮回殿行动路线

<div class="term-meta">
  <div><strong>Chinese</strong><span>轮回殿行动路线</span></div>
  <div><strong>English</strong><span>Reincarnation Palace Routes</span></div>
  <div><strong>Pinyin</strong><span>Lunhui Dian Luxian</span></div>
  <div><strong>Topic</strong><span>Realms & Regions</span></div>
</div>

## Summary

A route hub for Reincarnation Palace missions, strongholds, teleportation, and identity shifts.

## Role in RMJI

It expands Reincarnation Palace from an organization into an action network.
...
| Field | Detail |
| --- | --- |
| Chinese name | 轮回殿行动路线 |
| English name | Reincarnation Palace Routes |
| Pinyin | Lunhui Dian Luxian |
...
- [Reincarnation Palace Strongholds / 轮回殿据点](/en/rmji/regions/reincarnation-palace-strongholds)
- [Reincarnation Palace Thread / 轮回殿暗线](/en/rmji/timeline/reincarnation-palace-thread)
