...
description: "One of the support pills associated with major thresholds such as Core Formation."
---

# Dustfall Pill / 降尘丹

<div class="term-meta">
  <div><strong>Chinese</strong><span>降尘丹</span></div>
  <div><strong>English</strong><span>Dustfall Pill</span></div>
  <div><strong>Pinyin</strong><span>Jiangchen Dan</span></div>
  <div><strong>Topic</strong><span>Elixirs & Materials</span></div>
</div>

## Summary

One of the support pills associated with major thresholds such as Core Formation.
