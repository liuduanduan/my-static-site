...
title: "Healing Pills"
zh_name: "疗伤丹药"
en_name: "Healing Pills"
pinyin: "Liaoshang Danyao"
...
description: "A basic pill category for recovering after battles, secret realms, and flight."
---

# Healing Pills / 疗伤丹药

<div class="term-meta">
  <div><strong>Chinese</strong><span>疗伤丹药</span></div>
  <div><strong>English</strong><span>Healing Pills</span></div>
  <div><strong>Pinyin</strong><span>Liaoshang Danyao</span></div>
  <div><strong>Topic</strong><span>Elixirs & Materials</span></div>
</div>

## Summary

A basic pill category for recovering after battles, secret realms, and flight.

## Role in RMJI

It supports Han Li cycle of risk, recovery, and renewed action.
...
| Effect | It supports Han Li cycle of risk, recovery, and renewed action. |
...
| Chapter segment | Whole-series recurring resource related chapter segment |
| First check point | First appearance of Healing Pills remains to be refined by chapter |
| Main place | Mortal Realm |
| People | Han Li and related figures |
| Event | A basic pill category for recovering after battles, secret realms, and flight. |
| Materials / arts | Healing Pills |
