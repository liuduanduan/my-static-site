---
title: "Xuantian Spirit-Slaying Sword"
zh_name: "玄天斩灵剑"
en_name: "Xuantian Spirit-Slaying Sword"
pinyin: "Xuantian Zhanling Jian"
category: "Artifacts & Companions"
arc: "High-level Spirit Realm arc"
timeline_node: "Spirit Realm 01 | Ascension landing and Heavenly Abyss City"
check_status: "arc checked"
legacy_check_status: "high"
description: "A representative sword-type Xuantian treasure symbolizing top Spirit Realm power and great-faction competition."
---

# Xuantian Spirit-Slaying Sword / 玄天斩灵剑

<div class="term-meta">
  <div><strong>Chinese</strong><span>玄天斩灵剑</span></div>
  <div><strong>English</strong><span>Xuantian Spirit-Slaying Sword</span></div>
  <div><strong>Pinyin</strong><span>Xuantian Zhanling Jian</span></div>
  <div><strong>Topic</strong><span>Artifacts & Companions</span></div>
</div>

## Summary

A representative sword-type Xuantian treasure symbolizing top Spirit Realm power and great-faction competition.

## Role in RMJI

Read it with Xuantian treasures, sword methods, and Spirit Realm racial conflicts.
...
| Arc label | High-level Spirit Realm arc |
| Chapter segment | High-level Spirit Realm arc related chapter segment |
...
| Source / acquisition | High-level Spirit Realm arc related chapter segment |
...
| Effect | Read it with Xuantian treasures, sword methods, and Spirit Realm racial conflicts. |
...
| Chapter segment | High-level Spirit Realm arc related chapter segment |
| First check point | First appearance of Xuantian Spirit-Slaying Sword remains to be refined by chapter |
| Main place | Spirit Realm |
| People | Han Li and related figures |
| Event | A representative sword-type Xuantian treasure symbolizing top Spirit Realm power and great-faction competition. |
| Materials / arts | Xuantian Spirit-Slaying Sword |
...
| --- | --- |
| Chinese name | 玄天斩灵剑 |
| English name | Xuantian Spirit-Slaying Sword |
| Pinyin | Xuantian Zhanling Jian |
| Topic | [Artifacts & Companions](/en/rmji/artifacts/) |
| Timeline node | Spirit Realm 01 | Ascension landing and Heavenly Abyss City |
| Main arc | High-level Spirit Realm arc |
| Chapter check | arc checked |
| Legacy confidence | high |

## Related Entries

- [Xuantian Treasure / 玄天之宝](/en/rmji/artifacts/xuantian-treasure)
- [Sword Dao Law / 剑道法则](/en/rmji/laws/sword-law)
- [Spirit Realm / 灵界](/en/rmji/regions/spirit-realm)
