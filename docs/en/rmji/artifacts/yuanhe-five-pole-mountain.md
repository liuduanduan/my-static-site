---
title: "Yuanhe Five-Pole Mountain"
zh_name: "元合五极山"
...
description: "A high-level treasure thread associated with suppression, defense, and heavy artifact power."
---

# Yuanhe Five-Pole Mountain / 元合五极山

<div class="term-meta">
  <div><strong>Chinese</strong><span>元合五极山</span></div>
  <div><strong>English</strong><span>Yuanhe Five-Pole Mountain</span></div>
  <div><strong>Pinyin</strong><span>Yuanhe Wuji Shan</span></div>
  <div><strong>Topic</strong><span>Artifacts & Companions</span></div>
</div>

## Summary

A high-level treasure thread associated with suppression, defense, and heavy artifact power.

## Role in RMJI

Later passes can add materials, acquisition path, and concrete battle scenes.
...
| Effect | Later passes can add materials, acquisition path, and concrete battle scenes. |
...
| --- | --- |
| Chinese name | 元合五极山 |
| English name | Yuanhe Five-Pole Mountain |
| Pinyin | Yuanhe Wuji Shan |
