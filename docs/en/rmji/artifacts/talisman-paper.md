---
title: "Talisman Paper"
zh_name: "符纸"
en_name: "Talisman Paper"
pinyin: "Fuzhi"
category: "Artifacts & Companions"
arc: "Talisman crafting thread"
...
description: "The base material for talismans, linking herbs, craft, and low-level combat consumables."
---

# Talisman Paper / 符纸

<div class="term-meta">
  <div><strong>Chinese</strong><span>符纸</span></div>
  <div><strong>English</strong><span>Talisman Paper</span></div>
  <div><strong>Pinyin</strong><span>Fuzhi</span></div>
  <div><strong>Topic</strong><span>Artifacts & Companions</span></div>
</div>

## Summary

The base material for talismans, linking herbs, craft, and low-level combat consumables.

## Role in RMJI

It gives talisman crafting a material chain rather than leaving it abstract.
...
| Arc label | Talisman crafting thread |
| Chapter segment | Talisman crafting thread related chapter segment |
...
| Source / acquisition | Talisman crafting thread related chapter segment |
...
| Effect | It gives talisman crafting a material chain rather than leaving it abstract. |
...
| Chapter segment | Talisman crafting thread related chapter segment |
| First check point | First appearance of Talisman Paper remains to be refined by chapter |
| Main place | Mortal Realm |
| People | Han Li and related figures |
| Event | The base material for talismans, linking herbs, craft, and low-level combat consumables. |
| Materials / arts | Talisman Paper |
...
| --- | --- |
| Chinese name | 符纸 |
| English name | Talisman Paper |
| Pinyin | Fuzhi |
| Topic | [Artifacts & Companions](/en/rmji/artifacts/) |
| Timeline node | Mortal Realm 03 | Yue Seven Sects and Foundation Establishment |
| Main arc | Talisman crafting thread |
| Chapter check | estimated |
| Legacy confidence | medium |

## Related Entries

- [Talisman Crafting / 制符术](/en/rmji/techniques/talisman-making)
- [Seven-Star Grass / 七星草](/en/rmji/elixirs/seven-star-grass)
