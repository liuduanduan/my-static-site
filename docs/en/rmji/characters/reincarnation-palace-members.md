---
title: "Reincarnation Palace Members"
zh_name: "轮回殿成员群像"
en_name: "Reincarnation Palace Members"
pinyin: "Lunhui Dian Chengyuan"
category: "Characters"
...
description: "A group entry for Reincarnation Palace mission members, disguised identities, contacts, and hidden-thread figures."
---

# Reincarnation Palace Members / 轮回殿成员群像

<div class="term-meta">
  <div><strong>Chinese</strong><span>轮回殿成员群像</span></div>
  <div><strong>English</strong><span>Reincarnation Palace Members</span></div>
  <div><strong>Pinyin</strong><span>Lunhui Dian Chengyuan</span></div>
  <div><strong>Topic</strong><span>Characters</span></div>
</div>

## Summary

A group entry for Reincarnation Palace mission members, disguised identities, contacts, and hidden-thread figures.

## Role in RMJI

It makes Reincarnation Palace an action network beyond its master and strongholds.
...
| First / major meeting | Completes the main structure of time law, reincarnation law, Heavenly Court order, and Dao Ancestor status. |
| Cultivation at meeting / main stage | Immortal World Arc realm details remain chapter-level work; currently located by arc and role. |
| Identity and faction | A group entry for Reincarnation Palace mission members, disguised identities, contacts, and hidden-thread figures. |
| Arts, laws, or treasures | Reincarnation Palace, Jiao San, Fox Three |
| Relation to Han Li | It makes Reincarnation Palace an action network beyond its master and strongholds. |
| Outcome / later thread | Located by arc; exact chapters and relationship changes can be refined later. |
| Age precision | after about age 12500 into the finale |
...
| Field | Detail |
| --- | --- |
| Chinese name | 轮回殿成员群像 |
| English name | Reincarnation Palace Members |
| Pinyin | Lunhui Dian Chengyuan |
...
- [Fox Three / 狐三](/en/rmji/characters/fox-three)
