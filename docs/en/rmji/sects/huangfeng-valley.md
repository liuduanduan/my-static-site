...
check_status: "high"
description: "One of the Yue sects and the stage where Han Li formally enters sect-based cultivation society."
---

# Yellow Maple Valley / 黄枫谷

<div class="term-meta">
  <div><strong>Chinese</strong><span>黄枫谷</span></div>
  <div><strong>English</strong><span>Yellow Maple Valley</span></div>
  <div><strong>Pinyin</strong><span>Huangfeng Gu</span></div>
  <div><strong>Topic</strong><span>Sects & Factions</span></div>
</div>

## Summary

One of the Yue sects and the stage where Han Li formally enters sect-based cultivation society.

## Role in RMJI

It is ideal for explaining Foundation Establishment Pills, sect missions, disciple hierarchy, and early resource competition.
...
| --- | --- |
| Chinese name | 黄枫谷 |
| English name | Yellow Maple Valley |
| Pinyin | Huangfeng Gu |
