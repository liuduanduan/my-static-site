...
description: "An important sect stage after Han Li enters the order of the Immortal World Arc."
---

# Candle Dragon Dao / 烛龙道

<div class="term-meta">
  <div><strong>Chinese</strong><span>烛龙道</span></div>
  <div><strong>English</strong><span>Candle Dragon Dao</span></div>
  <div><strong>Pinyin</strong><span>Zhulong Dao</span></div>
  <div><strong>Topic</strong><span>Sects & Factions</span></div>
</div>

## Summary

An important sect stage after Han Li enters the order of the Immortal World Arc.

## Role in RMJI

It is a core page for early sequel organization ecology, identity placement, and mission structure.
...
| --- | --- |
| Chinese name | 烛龙道 |
| English name | Candle Dragon Dao |
| Pinyin | Zhulong Dao |
