---
title: "Clear Void Sect"
zh_name: "清虚门"
en_name: "Clear Void Sect"
pinyin: "Qingxu Men"
...
description: "One of the Yue sects, useful for completing the early Yue sect map."
---

# Clear Void Sect / 清虚门

<div class="term-meta">
  <div><strong>Chinese</strong><span>清虚门</span></div>
  <div><strong>English</strong><span>Clear Void Sect</span></div>
  <div><strong>Pinyin</strong><span>Qingxu Men</span></div>
  <div><strong>Topic</strong><span>Sects & Factions</span></div>
</div>

## Summary

One of the Yue sects, useful for completing the early Yue sect map.

## Role in RMJI

This seed records its map position first; later passes can add figures and events.
...
| Chapter segment | Mortal Realm early-middle arc related chapter segment |
...
| Chapter segment | Mortal Realm early-middle arc related chapter segment |
| First check point | First appearance of Clear Void Sect remains to be refined by chapter |
| Main place | Mortal Realm |
| People | Han Li and related figures |
| Event | One of the Yue sects, useful for completing the early Yue sect map. |
