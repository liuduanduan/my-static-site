...
description: "A high-level sequel faction suited to the immortal sect and Dao Ancestor faction group."
---

# Nine Origin Temple / 九元观

<div class="term-meta">
  <div><strong>Chinese</strong><span>九元观</span></div>
  <div><strong>English</strong><span>Nine Origin Temple</span></div>
  <div><strong>Pinyin</strong><span>Jiuyuan Guan</span></div>
  <div><strong>Topic</strong><span>Sects & Factions</span></div>
</div>

## Summary

A high-level sequel faction suited to the immortal sect and Dao Ancestor faction group.

## Role in RMJI

This batch creates the entry; later passes should add figures, law path, and key events.
...
| --- | --- |
| Chinese name | 九元观 |
| English name | Nine Origin Temple |
| Pinyin | Jiuyuan Guan |
...
- [Dao Ancestor System / 道祖体系](/en/rmji/laws/dao-ancestor-system)
