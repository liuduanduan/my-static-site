---
title: "Heavenly South Cultivator Alliance"
zh_name: "天南修士联盟"
en_name: "Heavenly South Cultivator Alliance"
pinyin: "Tiannan Xiushi Lianmeng"
category: "Sects & Factions"
arc: "Mortal Realm middle-late arc"
check_status: "medium"
description: "A joint structure formed by Heavenly South cultivators under large-scale pressure."
---

# Heavenly South Cultivator Alliance / 天南修士联盟

<div class="term-meta">
  <div><strong>Chinese</strong><span>天南修士联盟</span></div>
  <div><strong>English</strong><span>Heavenly South Cultivator Alliance</span></div>
  <div><strong>Pinyin</strong><span>Tiannan Xiushi Lianmeng</span></div>
  <div><strong>Topic</strong><span>Sects & Factions</span></div>
</div>

## Summary

A joint structure formed by Heavenly South cultivators under large-scale pressure.

## Role in RMJI

It upgrades early sect competition into regional community and wartime mobilization.
...
| --- | --- |
| Chinese name | 天南修士联盟 |
| English name | Heavenly South Cultivator Alliance |
| Pinyin | Tiannan Xiushi Lianmeng |
...
- [Return to Heavenly South / 返回天南](/en/rmji/timeline/return-to-heavenly-south)
