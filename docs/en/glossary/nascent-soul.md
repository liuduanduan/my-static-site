...
Nascent Soul cultivators are usually treated as major powers. Their spiritual self can sense farther, use stronger divine sense, and in some settings flee the body after defeat. The realm often follows [Golden Core](/en/glossary/golden-core).

## Related Terms

- [Golden Core](/en/glossary/golden-core)
- [Nascent Soul Realm](/en/cultivation-system/nascent-soul)
