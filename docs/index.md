...
hero:
  ...
  text: 《逍遥长生录》
  tagline: The Xianxia Encyclopedia for the Unfettered Soul. 「不加班，不 ICU，只修仙」
  image:
    src: /logo.svg
    alt: NoICU Cultivator 标志
  actions:
    - theme: brand
      text: 搜索术语
      link: /glossary/
...
features:
  - icon: 🧘
    title: 十四级修炼体系
    details: 从炼气期到道祖境，整理寿元、突破条件、核心特征与叙事作用。
  - icon: 📖
    title: 中英双语词典
    details: 核心术语提供中文、英文、拼音、分类、摘要、正文和相关词条。
  - icon: 📚
    title: 经典作品索引
    details: 覆盖凡人流、洪荒流、宗门流、古典仙侠与玄幻仙侠代表作品。
  - icon: ✨
    title: 文化背景
    details: 解释道教、内丹术、五行八卦、神话中的仙与修真文学演变。
---

<section class="hero-panel">
  <p class="eyebrow">No 996, No ICU, Just Cultivation.</p>
  <form class="home-search" action="/glossary/" method="get">
    <input name="q" type="search" aria-label="搜索500+修仙词条" placeholder="搜索500+修仙词条... Search 500+ cultivation terms..." />
    <button type="submit">搜索</button>
  </form>
  <div class="hot-tags" aria-label="热门标签">
    <a href="/glossary/qi">#灵气 Qi</a>
    <a href="/glossary/golden-core">#金丹 Golden Core</a>
    <a href="/glossary/nascent-soul">#元婴 Nascent Soul</a>
...
<div class="category-grid home-category-grid">
  <a class="category-row" href="/categories/cultivation-realms"><span class="icon">🧘</span><h3>修炼境界</h3><p>Cultivation Realms</p><strong>14 词条</strong></a>
  <a class="category-row" href="/categories/techniques-and-arts"><span class="icon">⚔️</span><h3>功法武学</h3><p>Techniques & Arts</p><strong>8+ 词条</strong></a>
  <a class="category-row" href="/categories/elixirs-and-pills"><span class="icon">🧪</span><h3>灵药丹方</h3><p>Elixirs & Pills</p><strong>6+ 词条</strong></a>
  <a class="category-row" href="/categories/divine-weapons"><span class="icon">🗡️</span><h3>神兵利器</h3><p>Divine Weapons</p><strong>6+ 词条</strong></a>
  <a class="category-row" href="/categories/sects-and-clans"><span class="icon">🏯</span><h3>修仙门派</h3><p>Sects & Clans</p><strong>8+ 词条</strong></a>
  <a class="category-row" href="/categories/natural-treasures"><span class="icon">💎</span><h3>天材地宝</h3><p>Natural Treasures</p><strong>5+ 词条</strong></a>
  <a class="category-row" href="/categories/formations-and-talismans"><span class="icon">✨</span><h3>阵法符箓</h3><p>Formations & Talismans</p><strong>5+ 词条</strong></a>
  <a class="category-row" href="/categories/beasts-and-demons"><span class="icon">🐉</span><h3>妖魔鬼怪</h3><p>Beasts & Demons</p><strong>6+ 词条</strong></a>
...
<div class="entry-grid">
  <a class="entry-card" href="/glossary/qi"><h3>灵气 Qi</h3><p class="muted">核心术语 · 今日更新</p><p>修士吸收、炼化和突破的基础能量。</p></a>
  ...
  <a class="entry-card" href="/culture/xianxia-literary-evolution"><h3>修真小说流派演变</h3><p class="muted">文化背景 · 今日更新</p><p>从古典仙侠到凡人流、洪荒流与宗门流。</p></a>
</div>
